...
return [
    ...
    */
    ...
    'default' => [
        ...
        'generate_webp' => env('MOONSHINE_INTERVENTION_IMAGE_WEBP', true),
        'generate_avif' => env('MOONSHINE_INTERVENTION_IMAGE_AVIF', true),
        'strip_metadata' => env('MOONSHINE_INTERVENTION_IMAGE_STRIP_METADATA', true),
        'max_width' => env('MOONSHINE_INTERVENTION_IMAGE_MAX_WIDTH', 1920),
        'max_height' => env('MOONSHINE_INTERVENTION_IMAGE_MAX_HEIGHT', 1080),
    ...
    */
    ...
    'png' => [
        'indexed' => env('MOONSHINE_INTERVENTION_IMAGE_PNG_INDEXED', false),
